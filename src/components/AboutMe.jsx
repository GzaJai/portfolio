...
const AboutMe = () => {
  return (
    <div className='flex flex-col w-[40%] mb-40 text-[#333] items-center mx-auto md:w-[50%] md:flex-row md:mb-52'>
        <div className=''>
            ...
            <div className='flex gap-[2rem]'>
                <div className='w-[6rem] mt-12 p-4 flex flex-col bg-indigo-300 rounded-lg text-center md:flex-row md:w-fit md:items-center'>
        ...
        <a className='box-content p-3 w-[50%] mt-[3rem] bg-indigo-500 hover:bg-orange-500 duration-150 flex flex-col items-center justify-center rounded-lg text-white md:w-[20%]' href="https://drive.google.com/file/d/1D3soKZYe1209oMMfySGhf3czffn0tLLO/view?usp=sharing" target='_blank'>
            <div>
